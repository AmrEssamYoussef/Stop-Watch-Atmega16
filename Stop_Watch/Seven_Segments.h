...
// this style in displaying is used to display all the digits at once and allow the change in any of them
...
void display(){
	...
	if(HoursTwo == 2 && HoursOne == 4 && MinutesTwo == 0
			&& MinutesOne == 0 && SecondsOne == 0 && SecondsTwo == 0 ){
		SecondsOne = SecondsTwo = 0;
		MinutesOne = MinutesTwo = 0;
		HoursOne   = HoursTwo   = 0;
